...
public class EmployeeEntity : EntityBase
{
    ...
    [Header("Physics")]
    [SerializeField] private PhysicsMaterial2D _frictionlessMaterial; // 可在 Inspector 绑定
    ...
    protected override void OnEntityInit(object userData)
    {
        ...
        // 消除物理摩擦，防止蹭墙减速
        EnsureFrictionlessMaterial(ref _frictionlessMaterial, "EmployeeFrictionless");
